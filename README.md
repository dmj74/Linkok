...
> نکته: برای فعال کردن مسیردهی دامنه‌های اختصاصی، بهتر است `BASE_URL` را روی دامنه اصلی سایت تنظیم کنید (مثلاً `BASE_URL=https://linkok.ir`). در این حالت هاست اصلی و هاست‌های اختصاصی به‌درستی از هم تفکیک می‌شوند.
